...
import createPlaceRouter from "./Place.router";
...
import { ClientType as PlaceClientType } from "./Place.router";
...
export function createRouter<Config extends BaseConfig>(router: RouterFactory<Config>, procedure: ProcBuilder<Config>) {
    return router({
        ...
        place: createPlaceRouter(router, procedure),
...
export interface ClientType<AppRouter extends AnyRouter> {
    ...
    place: PlaceClientType<AppRouter>;
